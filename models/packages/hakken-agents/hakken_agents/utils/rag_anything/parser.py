    ...
    def parse_pdf(
        ...
        **kwargs,
        ...
        try:
            ...
            self.logger.error(f"Error in parse_pdf: {e!s}")
            raise
    ...
    def parse_image(
        ...
        **kwargs,
        ...
        try:
            ...
            self.logger.error(f"Error in parse_image: {e!s}")
            raise
    ...
    def parse_office_doc(
        ...
        **kwargs,
        ...
        try:
            ...
            self.logger.error(f"Error in parse_office_doc: {e!s}")
            raise
    ...
    def parse_text_file(
        ...
        **kwargs,
        ...
        try:
            ...
            self.logger.error(f"Error in parse_text_file: {e!s}")
            raise
    ...
    def _read_output_files(
        ...
        if json_file.exists():
            try:
                ...
                self.logger.warning(f"Could not read or convert JSON file {json_file}: {e}")
        return content_list, md_content
    ...
    def parse_html(
        ...
        **kwargs,
        ...
        try:
            ...
            self.logger.error(f"Error in parse_html: {e!s}")
            raise
