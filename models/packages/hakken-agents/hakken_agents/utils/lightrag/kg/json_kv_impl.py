...
from hakken_agents.utils.lightrag.exceptions import StorageNotInitializedError
...
from hakken_agents.utils.lightrag.utils import load_json, write_json
...
class JsonKVStorage(BaseKVStorage):
    ...
    async def _migrate_legacy_cache_structure(self, data: dict) -> dict:
        ...
        """
        from hakken_agents.utils.lightrag.utils import generate_cache_key
