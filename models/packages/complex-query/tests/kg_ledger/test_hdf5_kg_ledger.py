...
def hdf5_file_path(tmp_path):
    return tmp_path / "test_knowledge_graph.h5"


@pytest.fixture
def ledger(hdf5_file_path):
    config = HDF5KGLedgerConfig(file_path=hdf5_file_path)
    return HDF5KnowledgeGraphLedger(config)
