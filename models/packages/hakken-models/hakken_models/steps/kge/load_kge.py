...
from hakken_models.models.kge import KGE, KGELoader
...
def load_kge_artifacts_step(
    config: ModelLoaderConfig,
) -> tuple[
    Annotated[KGE, ArtifactConfig(name="kge")],
    ...
    loader = KGELoader(config)
    artifacts = loader.load()

    logger.success("KGE artifacts loaded successfully.")

    return artifacts.kge, artifacts.dataset
