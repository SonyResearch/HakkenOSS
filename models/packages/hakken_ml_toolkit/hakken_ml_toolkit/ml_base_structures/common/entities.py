...
FloatTensor1D = Annotated[torch.FloatTensor, "Represents a float tensor with 1 dimension"]
FloatTensor2D = Annotated[torch.FloatTensor, "Represents a float tensor with 2 dimensions"]
