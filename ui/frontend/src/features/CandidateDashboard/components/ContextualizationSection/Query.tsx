/*Contextualization section for the candidate results*/
...
import QueryExplanationLoadingButtons from '../ExplanationLoadingButtons/Query';
import { CandidateResultType, Filters, Sorting } from '../../types';
